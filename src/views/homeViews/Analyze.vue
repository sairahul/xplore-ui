...
export default {
  ...
  methods: {
    ...
    getImagesList(_classificationId){
      if(this.$router.currentRoute.params.classificationId != _classificationId){
    ...
    selectImage(_image){
      if(_image && this.$router.currentRoute.params.imageId != _image.id){
